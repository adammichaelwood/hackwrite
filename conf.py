...
BLOG_AUTHOR = "Adam Michael Wood"  # (translatable)
BLOG_TITLE = "hack.write()"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://hackwrite.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://adammichaelwood.com/hackwrite/"
BLOG_EMAIL = "adam.michael.wood@gmail.com"
BLOG_DESCRIPTION = "Writing about writing about development."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS feed"),
        ("https://github.com/adammichaelwood/hackwrite", "Repo"),
    ),
}
...
# (translatable)
CONTENT_FOOTER = '&copy; 2016&ndash;{date} <a href="mailto:{email}">{author}</a> - {license} <br><span id="powered-by">Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a></span>'
...
# is in the manual.
COMMENT_SYSTEM_ID = "adammichaelwood"
